...
def get_parser(**parser_kwargs):
    ...
    # default
    parser.add_argument("-n", "--name",             type=str,       nargs="?",  default="CRACK")
    ...
    # train.sh
    parser.add_argument("-b", "--base",             type=str,       nargs="?",  default="configs/train_1.yaml")
    parser.add_argument("-l", "--logdir",           type=str,       nargs="?",  default="logs")
    parser.add_argument("-p", "--pretrained_model", type=str,       nargs="?",  default="checkpoints/pbe_dim2_cross.ckpt")
    return parser


class ImageLogger(Callback):
    def __init__(self, batch_frequency=500, log_steps=[1]):
        super().__init__()
...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, 
        ...
        self.num_workers = 0#batch_size * 2
...
if __name__ == "__main__":
    ...
    default_callbacks_cfg = {
        ...
        "image_logger": {
            ...
            "params": {"batch_frequency": 500, "log_steps": [10]}
        },
    ...
    #trainer_kwargs["callbacks"] = [ModelCheckpoint(every_n_train_steps=1850, save_top_k=-1)]
    # =============================================================
